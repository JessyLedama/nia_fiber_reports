...
class GeneralLedgerReport(models.TransientModel):
    ...
    def check_excel_report(self):
        ...
        products = self.env['account.move.line'].search_read([('parent_state', '=', 'posted')]) 
    ...
    def print_excel_report(self, data):
        return self.env.ref('nia_fiber_reports.action_general_ledger_report_xlsx').report_action(self, data=data, config=False)
