...
class ChartOfAccountsReport(models.TransientModel):
    ...
    def check_excel_report(self):
        ...
        products = self.env['account.account'].search_read() 
    ...
    def print_excel_report(self, data):
        return self.env.ref('nia_fiber_reports.action_chart_of_accounts_report_xlsx').report_action(self, data=data, config=False)
