...
class PurchaseInvoice(models.TransientModel):
    ...
    def _print_report(self, data):
        ...
        return self.env.ref('nia_fiber_reports.action_purchase_invoice').report_action(self, data=data, config=False)


    # Excel Report
    def check_excel_report(self):
        products = self.env['account.move.line'].search_read([('journal_id', '=', 'Vendor Bills')]) # journal_id 2 = Vendor Bills.
    ...
    def print_excel_report(self, data):
        return self.env.ref('nia_fiber_reports.action_purchase_invoice_xlsx').report_action(self, data=data, config=False)
